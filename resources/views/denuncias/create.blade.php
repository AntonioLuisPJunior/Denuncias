    ...
    <div class="row">
      <div class="col-sm-7">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="email" placeholder="Localização" name="den_localizacao" value="{{ old('den_localizacao') }}">
      ...
      <div class="col-sm-3">
        <div class="form-group">
          ...
          <input type="text" class="form-control" id="email" placeholder="Observação" name="den_observacao" value="{{ old('den_observacao') }}">
      ...
      <div class="col-sm-2">
        <div class="form-group">
          ...
          <input type="number" class="form-control" name="den_quantidade_pessoas" id="" value="{{ old('den_quantidade_pessoas') }}">
